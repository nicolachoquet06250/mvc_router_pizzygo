 ...
 * @method \mvc_router\data\gesture\pizzygo\entities\User|bool get_all_from_pseudo_password(string $pseudo, string $password)
 * @method \mvc_router\data\gesture\pizzygo\entities\User|bool get_all_from_email_password(string $email, string $password)
